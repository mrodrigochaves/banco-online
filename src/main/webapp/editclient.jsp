...
<body>
<%@ page import="com.mrodrigochaves.bean.Cliente, com.mrodrigochaves.dao.ClienteDao"%>
...
<input type="hidden" name="id" value="<%=client.getId()%>"/>
	<table>
			...
			<tr>
				<td>Login: </td>
				<td><input type="email" name="login" value="<%=client.getLogin()%>"/></td>
			</tr>
			<tr>
				<td>Password: </td>
				<td><input type="password" name="password" value="<%=client.getPassword()%>"/></td>
			</tr>
			<tr>
			<td colspan="2"><input type="submit" value="Editar usuário"></input></td>
			</tr>
			<tr><td><a href="clientview.jsp">Voltar</a></td></tr>
